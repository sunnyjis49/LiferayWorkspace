...
public class EmployeeModelImpl extends BaseModelImpl<Employee>
	...
	public static final String TABLE_SQL_CREATE = "create table employee (empId INTEGER not null primary key,name VARCHAR(75) null,email VARCHAR(75) null,mobile VARCHAR(75) null)";
	...
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.employee.service.util.ServiceProps.get(
			...
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.employee.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.employee.model.Employee"),
			true);
